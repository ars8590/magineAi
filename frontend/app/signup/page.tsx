...
export default function SignupPage() {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        setError(null);
        try {
            const { token, user } = await userSignup(name, email, password);
                    ...
                    <div className="w-full max-w-[480px] mx-auto mt-12 lg:mt-0">
                        ...
                        <form onSubmit={onSubmit} className="flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <button type="button" className="flex items-center justify-center gap-2 h-12 rounded-lg border border-[#e9e7f3] dark:border-[#2f2b3a] bg-white dark:bg-[#1a1625] hover:bg-[#f9f8fc] dark:hover:bg-[#252033] transition-colors text-[#100d1b] dark:text-white font-medium text-sm">
                                    <img alt="Google" className="w-5 h-5" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDgDzssgxfv2US7rlXFYq4dWJTbVwFfO4rMovWzHynljeDX8343jbEgbuYoi49aMRhquoLPKwxnkIRn1mPvihdJe5w78C2rzc1i38wIQxKpl8Bkp_lGuZCEUOaAEtHOuhPhcF71Qx8Ozn4FTpz8bVsVC_dnXOMw3hEN8E-PSRqOr1AM06_9xrJBVevl0lktOjQniOylmRmYuN5UTijEwc8VtknwnGtYSxfPDKRgYeBLXlNJko6vvQfIOoUnFng-NGO3j6x1V9jovPZa" />
                                    Google
                                </button>
